...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build Territory result asset")
    parser.add_argument("--company-key", required=True)
    args = parser.parse_args()
    print(json.dumps(build_territory_result_asset(args.company_key), ensure_ascii=False, indent=2))
